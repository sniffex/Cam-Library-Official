...
const Nav = () => {
    ...
    return (
        ...
        <div className=' w-full fixed top-0 left-0'>
            ...
            <ul className={` lg:flex lg:items-center lg:pb-0 pb-12 absolute lg:static bg-white dark:bg-gray-900 lg:z-auto z-[-1] left-0 2xl:pr-28 xl:pr-0 lg:pr-0 md:pr-0
                                ...
                                <div className='flex flex-col gap-2 over'>
                                    <div className=' flex flex-row mb-3 gap-2 border-2 rounded-md'>
                                        <div className='flex justify-center'>
                                            <img src={item.image_link} alt="" target="_blank" className=' rounded-sm w-20 h-32' />
                                        </div>
                                        <div className='flex flex-col mt-1'>
                                            <p class=" text-md font-bold tracking-tight text-gray-900 dark:text-white">{item.title}</p>
                                            <p className='text-xs'>{item.description}</p> 
                                            <div className=' flex flex-row gap-1 mt-3'>
                                            <div className='px-2 py-1 bg-white border-2 rounded-lg'> 
                                            <a href={item.book_link} target='_blank' rel="noopener noreferrer" className=' hover:text-blue-700 text-gray-900 font-medium'>Views</a>
                                            </div>
                                            </div>
